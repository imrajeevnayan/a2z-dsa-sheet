...
Given a positive number n, print the string "GFG" exactly n times separated by a single space. Examples: Input: n = 5 Output: GFG GFG GFG GFG GFG Input: 3 Output: GFG GFG GFG Constraint: 1 ≤ n ≤ 103

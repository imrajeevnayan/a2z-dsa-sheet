...
This solution was accepted on LeetCode using Prefix Sum. The detected topics are Array, Binary Search, Dynamic Programming, Greedy, Prefix Sum. Review the synced source file for the implementation details.

...
This solution was accepted on LeetCode using Daily Question. The detected topics are Math, String, Greedy, Game Theory. Review the synced source file for the implementation details.

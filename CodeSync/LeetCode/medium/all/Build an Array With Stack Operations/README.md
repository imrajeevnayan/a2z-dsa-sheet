...
This solution was accepted on LeetCode using Stack. The detected topics are Array, Stack, Simulation. Review the synced source file for the implementation details.

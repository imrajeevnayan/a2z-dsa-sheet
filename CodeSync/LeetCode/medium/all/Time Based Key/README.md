...
This solution was accepted on LeetCode using Binary Search. The detected topics are Hash Table, String, Binary Search, Design. Review the synced source file for the implementation details.

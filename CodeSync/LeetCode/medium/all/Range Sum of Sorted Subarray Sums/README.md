...
This solution was accepted on LeetCode using Binary Search. The detected topics are Array, Two Pointers, Binary Search, Sorting, Prefix Sum. Review the synced source file for the implementation details.

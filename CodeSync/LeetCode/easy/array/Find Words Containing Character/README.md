...
This solution was accepted on LeetCode using Algorithms. The detected topics are Array, String. Review the synced source file for the implementation details.

...
This solution was accepted on LeetCode using Tree For Placement (Copy-5chyqxsi). The detected topics are Tree, Binary Search Tree, Binary Tree. Review the synced source file for the implementation details.

# Long Time No Seen, Aehhh Easy Question !!
...
This solution was accepted on LeetCode using Problem List. The detected topics are Linked List, Math. Review the synced source file for the implementation details.

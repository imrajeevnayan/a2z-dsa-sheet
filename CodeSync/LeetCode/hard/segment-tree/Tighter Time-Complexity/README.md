...
This solution was accepted on LeetCode using Daily Question. The detected topics are Array, String, Segment Tree, Ordered Set. Review the synced source file for the implementation details.

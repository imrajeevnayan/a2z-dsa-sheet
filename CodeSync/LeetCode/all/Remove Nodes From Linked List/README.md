...
This solution was accepted on LeetCode using Problem List. The detected topics are Linked List, Stack, Recursion, Monotonic Stack. Review the synced source file for the implementation details.

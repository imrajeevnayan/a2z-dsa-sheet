...
This solution was accepted on LeetCode using Problem List. The detected topics are Hash Table, Tree, Depth-First Search, Binary Tree. Review the synced source file for the implementation details.

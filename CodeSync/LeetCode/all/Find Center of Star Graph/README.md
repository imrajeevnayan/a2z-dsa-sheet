...
This solution was accepted on LeetCode using Graph Theory. The detected topics are Graph Theory. Review the synced source file for the implementation details.
